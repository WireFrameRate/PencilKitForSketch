...
This library contains four states of the Toolpicker: Horizontal, vertical, in motion, and minimized.  It contains light- and dark-mode implementations for each.

On the Toolpicker, there are control buttons, tools, and color pallette buttons.
